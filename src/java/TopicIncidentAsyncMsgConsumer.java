...
public class TopicIncidentAsyncMsgConsumer
       implements ExceptionListener, MessageListener
{
    ...
    public TopicIncidentAsyncMsgConsumer(String[] args)
    {
    ...
    public static void main(String[] args)
    {
        ...
        param[0] = "-topic"; // topic or queue?
        param[1] = "topic.sample"; // Destination or name of message
        new TopicIncidentAsyncMsgConsumer(param);
    }
