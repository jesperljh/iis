...
public class tibjmsMsgRRProducer {
    /*-----------------------------------------------------------------------
     * Parameters
     *----------------------------------------------------------------------*/
    ...
    String name = "q.getClientInfo_Reply";
    ...
    public tibjmsMsgRRProducer(String[] args) {
        parseArgs(args);
        ...
        try {
           ...
           if (useTopic) {
                ...
                replyDestination = session.createTopic("reply.topic"); //for request-reply
           } else {
                destination = session.createQueue(name);
                replyDestination = session.createQueue("reply.queue"); //for request-reply
           }
    ...
    *----------------------------------------------------------------------*/
    ...
    public static void main(String[] args) {
        tibjmsMsgRRProducer t = new tibjmsMsgRRProducer(args);
    }
